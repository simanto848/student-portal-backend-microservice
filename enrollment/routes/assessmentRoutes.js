...
router.post('/types', authorize('super_admin', 'admin'), validate(createAssessmentTypeSchema), assessmentTypeController.createAssessmentType);
router.put('/types/:id', authorize('super_admin', 'admin'), validate(updateAssessmentTypeSchema), assessmentTypeController.updateAssessmentType);
router.delete('/types/:id', authorize('super_admin', 'admin'), validate(getAssessmentTypeSchema), assessmentTypeController.deleteAssessmentType);
...
router.delete('/:id', authorize('teacher'), validate(getAssessmentSchema), assessmentController.deleteAssessment);
router.post('/:id/publish', authorize('teacher'), validate(getAssessmentSchema), assessmentController.publishAssessment);
router.post('/:id/close', authorize('teacher'), validate(getAssessmentSchema), assessmentController.closeAssessment);
router.post('/:id/mark-graded', authorize('teacher'), validate(getAssessmentSchema), assessmentController.markAsGraded);
router.get('/', authorize('super_admin', 'admin', 'teacher', 'student'), validate(listAssessmentsSchema), assessmentController.listAssessments);
