...
export const studentCreateValidation = (data) => {
    const schema = z.object({
        ...
        expectedGraduationDate: dateCoerceOptional('Expected graduation date must be a valid date'),
...
export const studentUpdateValidation = (data) => {
    const schema = z.object({
        ...
        currentSemester: z.number()
            ...
            .optional(),
        expectedGraduationDate: dateCoerceOptional('Expected graduation date must be a valid date'),
        actualGraduationDate: dateCoerceOptional('Actual graduation date must be a valid date'),
        profile: z.any().optional(),
